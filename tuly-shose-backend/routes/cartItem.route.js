...
const { getAllCartItems, getCartItemById, addCartItem, getCartItemsByUserId, updateCartItemQuantity, deleteCartItem, syncGuestCart } = require('../controllers/cartItem.controller');
...
router.post('/customers/sync', syncGuestCart);
