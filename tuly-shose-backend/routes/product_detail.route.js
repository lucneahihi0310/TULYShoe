...
const { list_product_detail, list_product_detail_by_id, create_product_detail, edit_product_detail, delete_product_detail, get_product_detail_by_id } = require('../controllers/product_detail.controller');
...
router.get('/manager/get_product_detail/:id', get_product_detail_by_id);
